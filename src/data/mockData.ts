...
export const mockProviders: Provider[] = [
  ...
  },
  {
    ...
    usage: {
      sessionPercent: 35,
      weeklyPercent: 45,
      sessionLabel: '35% used (session)',
      weeklyLabel: '45% used (weekly)',
      trend: {
        direction: 'rising',
        points: [
          { timestamp: now - 7 * hour, value: 15 },
          { timestamp: now - 6 * hour, value: 20 },
          { timestamp: now - 5 * hour, value: 24 },
          { timestamp: now - 4 * hour, value: 27 },
          { timestamp: now - 3 * hour, value: 30 },
          { timestamp: now - 2 * hour, value: 32 },
          { timestamp: now - 1 * hour, value: 34 },
  ...
  },
  {
    ...
    usage: {
      sessionPercent: 15,
      weeklyPercent: 22,
      sessionLabel: '15% used (session)',
      weeklyLabel: '22% used (weekly)',
      trend: {
        direction: 'steady',
        points: [
          { timestamp: now - 7 * hour, value: 10 },
          { timestamp: now - 6 * hour, value: 12 },
          { timestamp: now - 5 * hour, value: 11 },
          { timestamp: now - 4 * hour, value: 13 },
          { timestamp: now - 3 * hour, value: 14 },
          { timestamp: now - 2 * hour, value: 14 },
          { timestamp: now - 1 * hour, value: 15 },
    ...
    statusInfo: {
      status: 'operational',
      description: 'All systems operational',
      lastChecked: now - 130000,
      statusPageUrl: 'https://kiro.dev',
      history: [
        { status: 'operational', timestamp: now - 24 * hour },
        { status: 'operational', timestamp: now - 48 * hour },
        { status: 'operational', timestamp: now - 72 * hour },
  ...
  },
  {
    ...
    usage: {
      sessionPercent: 5,
      weeklyPercent: 12,
      sessionLabel: '5% used (session)',
      weeklyLabel: '12% used (weekly)',
      trend: {
        direction: 'falling',
        points: [
          { timestamp: now - 7 * hour, value: 20 },
          { timestamp: now - 6 * hour, value: 18 },
          { timestamp: now - 5 * hour, value: 15 },
          { timestamp: now - 4 * hour, value: 12 },
          { timestamp: now - 3 * hour, value: 10 },
          { timestamp: now - 2 * hour, value: 8 },
          { timestamp: now - 1 * hour, value: 6 },
    ...
    statusInfo: {
      status: 'operational',
      description: 'All systems operational',
      lastChecked: now - 200000,
      statusPageUrl: 'https://augmentcode.com',
      history: [
        { status: 'operational', timestamp: now - 24 * hour },
        { status: 'operational', timestamp: now - 48 * hour },
        { status: 'operational', timestamp: now - 72 * hour },
  ...
  },
  {
    ...
    usage: {
      sessionPercent: 62,
      weeklyPercent: 50,
      sessionLabel: '62% used (session)',
      weeklyLabel: '50% used (weekly)',
      trend: {
        direction: 'rising',
        points: [
          { timestamp: now - 7 * hour, value: 30 },
          { timestamp: now - 6 * hour, value: 38 },
          { timestamp: now - 5 * hour, value: 42 },
          { timestamp: now - 4 * hour, value: 48 },
          { timestamp: now - 3 * hour, value: 52 },
          { timestamp: now - 2 * hour, value: 57 },
          { timestamp: now - 1 * hour, value: 60 },
    ...
    statusInfo: {
      status: 'operational',
      description: 'All systems operational',
      lastChecked: now - 110000,
      statusPageUrl: 'https://devin.ai',
      history: [
        { status: 'operational', timestamp: now - 24 * hour },
        { status: 'degraded', timestamp: now - 36 * hour },
        { status: 'operational', timestamp: now - 72 * hour },
      ],
    },
  },
